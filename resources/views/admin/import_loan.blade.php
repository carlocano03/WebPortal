          ...
          <div class="col">
            <div class="mp-pb4 mp-pv4 mp-card mp-card--tabbed">
              <div class="mp-pt3 mp-pb3 mp-text-fs-small mp-text-right">
                <a class="mp-link" href="{{url('/templates/loans_template.csv')}}">Download the template (csv)</a>

              </div>
              <form id="import" class="mp-dropzone" action="{{url('/admin/import_loan')}}" method="post" enctype="multipart/form-data">
