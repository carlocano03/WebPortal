...
<div class="container mp-container">
  ...
  <div class="row no-gutters mp-mt4 justify-content-center">
    <div class="col-12 mp-ph2 mp-pv2" style="padding-bottom: 0px!important;">
      <a href="{{url('/admin/loan-app')}}" class="mp-link mp-link">
 ...
 <div class="row no-gutters mp-mb4 justify-content-center">
  <div class="col-12 mp-ph2 mp-pv2">
    ...
    <div class="mp-ph4 mp-pv4 mp-card mp-card--plain" align='center'>
      <div class="mp-pt3 mp-pb3 mp-text-fs-medium mp-text-right">
        @if($loan->status=="DONE")
        <a class="mp-link mp-link--primary" href="{{url('/admin/edit-loan-form/'.$loan->id)}}">Edit Details</a>
        <br>  
        @endif
        <a class="mp-link" href="{{url('/admin/loan-form/'.$loan->id)}}"  target="_blank">Generate Loan Info Slip</a>
      </div>
    ...
    <div class="row mp-mb2">
      ...
      <div class="col-md-auto" style="width:300px;text-align: center!important;">{{date("m/d/Y", strtotime($loan->collect_from))}} to {{date("m/d/Y", strtotime($loan->collect_to))}}</div>
  ...
  @else
  <div align="center" class="mp-text-fs-medium mp-text-fw-heavy">
    <strong>Done Processing</strong>          
  </div>
  <br>
  {{ Form::open(array('url' => '/admin/loan-app-closed', 'method' => 'post', 'id'=>'close_application', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off')) }}
...
<br/>
  ...
  <div class="mp-pb4 mp-input-group" style="width:50%" align="left">
   ...
   <br>
   <br>
   <input type="checkbox" id="out_pel" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="out_bl" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="out_eml" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="out_cbl" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="int_pel" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="int_bl" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="int_eml" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="int_cbl" onclick="EnableDisableTextBox(this)">
   ...
   <br>
   <br>
   <input type="checkbox" id="surge" onclick="EnableDisableTextBox(this)">
   ...
   Others
   <br>
   <input type="checkbox" id="other1" onclick="EnableDisableTextBox(this)">
   <span align="left" >
     <input 
     class="mp-text-field" 
     type="text"
   ...
   <br>
   <input type="checkbox" id="other2" onclick="EnableDisableTextBox(this)">
...
<div class="mp-text-fs-medium mp-text-center">
 ...
 <br>
 <input type="submit" id="submit_close_application" style="visibility: hidden;">
</div>
@endif
{{ Form::close() }}
...
<br>
<div align="center" class="mp-text-fs-medium mp-text-fw-heavy">
  <strong>Cancel Application</strong>          
</div>

<br>
{{ Form::open(array('url' => '/admin/loan-app-cancel', 'method' => 'post', 'id'=>'cancel_application', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off')) }}

<div class="mp-pb4 mp-input-group" style="width:50%">
  <label class="mp-input-group__label" for="confirmPassword">
    Reason for Cancellation
  </label>
  <textarea id="reason" name="reason" rows="4" cols="60"></textarea>
...
@if($loan->status== 'SUBMITTED'||$loan->status=='PROCESSING')

<div class="mp-text-fs-medium mp-text-center">
  <button type="button" class="mp-button mp-button--primary cancel">CANCEL APPLICATION</button>
  <br>
  <input type="submit" id="submit_cancel_application" style="visibility: hidden;">
</div>
@endif
...
<br>
{{ Form::open(array('url' => '/admin/loan-app-closed', 'method' => 'post', 'id'=>'close_application_renewal', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off')) }}
...
<div class="mp-text-fs-medium mp-text-center">
 <button type="button" class="mp-button mp-button--accent save" >Done Processing Application</button>
 <br>
 <input type="submit" id="submit_close_application_renewal" style="visibility: hidden;">
</div>
@endif
{{ Form::close() }}
...
<br>
{{ Form::open(array('url' => '/admin/loan-app-cancel', 'method' => 'post', 'id'=>'cancel_application_renewal', 'enctype' => 'multipart/form-data', 'autocomplete'=>'off')) }}
...
<div class="mp-text-fs-medium mp-text-center">
  <button type="button" class="mp-button mp-button--primary cancel">CANCEL APPLICATION</button>
  <br>
  <input type="submit" id="submit_cancel_application_renewal" style="visibility: hidden;">
</div>
@endif
...
function compute_net(form_id) {
 ...
 var servicefee_amount= $( "#"+form_id+" :input[name='servicefee_amount']" ).val();

 if($( "#"+form_id+" :input[name='out_pel_amount']" ).val())
 {
   var out_pel_amount= $( "#"+form_id+" :input[name='out_pel_amount']" ).val();
 }
 else
 {
 ...
 {
   var out_eml_amount= $( "#"+form_id+" :input[name='out_eml_amount']" ).val();
 }
 else
 {
 ...
 {
   var out_bl_amount= $( "#"+form_id+" :input[name='out_bl_amount']" ).val();
 }
 else
 {
   var out_bl_amount= 0;
 ...
 {
   var out_cbl_amount= $( "#"+form_id+" :input[name='out_cbl_amount']" ).val();
 }
 else
 {
...
{
 var int_pel_amount= $( "#"+form_id+" :input[name='int_pel_amount']" ).val();
}
else
{
...
{
 var int_eml_amount= $( "#"+form_id+" :input[name='int_eml_amount']" ).val();
}
else
{
...
{
 var int_bl_amount= $( "#"+form_id+" :input[name='int_bl_amount']" ).val();
}
else
{
 var int_bl_amount= 0;
...
{
 var int_cbl_amount= $( "#"+form_id+" :input[name='int_cbl_amount']" ).val();
}
else
{
...
{
 var other1_amount= $( "#"+form_id+" :input[name='other1_amount']" ).val();
}
else
{
 var other1_amount= 0;
...
{
 var other2_amount= $( "#"+form_id+" :input[name='other2_amount']" ).val();
}
else
{
 var other2_amount= 0;
...
{
 var surge_amount= $( "#"+form_id+" :input[name='surge_amount']" ).val();
}
else
{
 var surge_amount= 0;
